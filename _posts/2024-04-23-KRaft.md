...
![](event-driven-consensus-internals.png)
...
![](a5d1edbd27ed970654d68044e44759d97a87c0e265c6b4c5392873658a2232a5.png)
...
![](cc90a482f0e93f51a9a5d28408c5d4fba69d0fc4fab8e3a52ff864d6c26965ed.png)
...
![](timed-shutdown-operations-in-apache-kafka-with-or-without-zookeeper.png)
...
* N이 홀수(2k+1)일 때 :k**개 노드**의 장애까지 허용 가능
* N이 짝수(2k)일 때 :k-1**개 노드**의 장애까지 허용 가능
