...
관찰 가능성이라는 용어에는Trace, Metric, Log를 구성하는 도구의 `원격측정(telemtry)`데이터를 생성/수집함으로써 소프트웨어 작동의 가시성을 높이는 작업이 포함된다.
...
graph LR
    ...
    style A fill:#c2e0ff,stroke:#1a73e8
    style B fill:#b9e2b9,stroke:#28a745
    style C fill:#ffeeba,stroke:#ffc107
